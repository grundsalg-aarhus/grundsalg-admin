...
class SalgshistorikController extends Controller
{
     ...
     *
     * @Route("/", name="admin_salgshistorik_index")
     * @Method("GET")
     */
     ...
     *
     * @Route("/new", name="admin_salgshistorik_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_salgshistorik_show', array('id' => $salgshistorik->getId()));
        }
     ...
     *
     * @Route("/{id}", name="admin_salgshistorik_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{id}/edit", name="admin_salgshistorik_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Salgshistorik $salgshistorik)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('admin_salgshistorik_edit', array('id' => $salgshistorik->getId()));
        }
     ...
     *
     * @Route("/{id}", name="admin_salgshistorik_delete")
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, Salgshistorik $salgshistorik)
    {
        ...
        return $this->redirectToRoute('admin_salgshistorik_index');
    }
    ...
    private function createDeleteForm(Salgshistorik $salgshistorik)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_salgshistorik_delete', array('id' => $salgshistorik->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
