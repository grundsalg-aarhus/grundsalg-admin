...
class Version00000000000080 extends AbstractMigration
{
  ...
  public function up(Schema $schema)
  {
    ...
    $this->addSql('ALTER TABLE Landinspektoer CHANGE email email VARCHAR(50) DEFAULT NULL');
    $this->addSql('ALTER TABLE Landinspektoer CHANGE mobil mobil VARCHAR(20) DEFAULT NULL');
    ...
    // longtext to VARCHAR conversion
    $this->addSql('ALTER TABLE Delomraade CHANGE anvendelse anvendelse VARCHAR(50) DEFAULT NULL');
    $this->addSql('ALTER TABLE Delomraade CHANGE mulighedFor mulighedFor VARCHAR(50) DEFAULT NULL');
    ...
    $this->addSql('ALTER TABLE Salgsomraade CHANGE matrikkel1 matrikkel1 VARCHAR(20) DEFAULT NULL');
    $this->addSql('ALTER TABLE Salgsomraade CHANGE matrikkel2 matrikkel2 VARCHAR(20) DEFAULT NULL');
    $this->addSql('ALTER TABLE Salgsomraade CHANGE ejerlav ejerlav VARCHAR(60) DEFAULT NULL');
    $this->addSql('ALTER TABLE Salgsomraade CHANGE vej vej VARCHAR(60) DEFAULT NULL');
    $this->addSql('ALTER TABLE Salgsomraade CHANGE gisUrl gisUrl VARCHAR(255) DEFAULT NULL');
    $this->addSql('ALTER TABLE Salgsomraade CHANGE tilsluttet tilsluttet VARCHAR(50) DEFAULT NULL');
    $this->addSql('ALTER TABLE Salgsomraade CHANGE sagsNr sagsNr VARCHAR(50) DEFAULT NULL');
    ...
    // longtext to VARCHAR conversion
    $this->addSql('ALTER TABLE Interessent CHANGE navn navn VARCHAR(255) DEFAULT NULL');
    $this->addSql('ALTER TABLE Interessent CHANGE adresse adresse VARCHAR(100) DEFAULT NULL');
    $this->addSql('ALTER TABLE Interessent CHANGE land land VARCHAR(50) DEFAULT NULL');
    $this->addSql('ALTER TABLE Interessent CHANGE koeberEmail koeberEmail VARCHAR(120) DEFAULT NULL');
    $this->addSql('ALTER TABLE Interessent CHANGE navn1 navn1 VARCHAR(120) DEFAULT NULL');
    $this->addSql('ALTER TABLE Interessent CHANGE adresse1 adresse1 VARCHAR(120) DEFAULT NULL');
    $this->addSql('ALTER TABLE Interessent CHANGE land1 land1 VARCHAR(50) DEFAULT NULL');
